...
export const ContactSection = () => {
  ...
  return (
    <section
      ...
      style={{ background: "rgba(0,5,10,0.8)" }}
    >
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/50 font-display max-w-md mx-auto">
            Questions about the platform or need a technical consultation?
        ...
        {status === "success" ? (
          <div className="border border-brand-green/30 bg-brand-green/5 p-12 text-center">
            ...
            <div className="font-mono text-sm text-brand-green tracking-widest mb-2">
              MESSAGE_SENT
            </div>
            ...
            <button
              ...
              className="mt-6 font-mono text-xs text-white/30 hover:text-white transition-colors underline underline-offset-4"
            >
